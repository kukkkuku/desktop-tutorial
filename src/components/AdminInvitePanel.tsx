  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="mt-0.5 text-xs text-gray-500">이메일을 줄바꿈/쉼표로 구분해 붙여넣거나, 엑셀 파일을 업로드하세요.</p>
        <textarea
          value={pasteText}
      ...
      <div className="border-t border-gray-100 pt-3">
        ...
        <input
          ...
          className="mt-2 w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-accent focus:outline-none"
        />
        <textarea
          value={body}
        ...
        {sendResult && (
          <div className={`mt-2 rounded-md px-2.5 py-2 text-xs ${sendResult.failed.length > 0 ? 'bg-red-50 text-danger' : 'bg-green-50 text-green-700'}`}>
            <p>
