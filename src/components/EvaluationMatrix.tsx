...
export default function EvaluationMatrix() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-600">과제마다 성과등급을 고르고, 팀원 기여도를 합계 100%가 되게 입력하세요. 참여하지 않은 칸은 비워 두면 됩니다.</p>
                        ...
                        <div className="mt-1 flex items-center gap-1.5 text-xs text-gray-500">
                          ...
                          <select
                            ...
                            className={`h-6 rounded border px-1 text-xs ${
                              task.performanceGrade ? 'border-gray-300 text-black' : 'border-orange-300 bg-orange-50 text-orange-700'
                            }`}
                          >
                          ...
                          <Fragment key={member.id}>
                            <td className="border-l border-gray-200 px-3 py-2">
                              <input
                                ...
                                className={`w-full rounded-md border px-2 py-1 text-sm text-black ${percent ? 'border-gray-300' : 'border-gray-200 bg-gray-50/60'}`}
                              />
                              {(() => {
