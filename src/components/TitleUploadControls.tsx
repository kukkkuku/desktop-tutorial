  ...
  return (
    <div className="relative flex shrink-0 flex-wrap items-center gap-2">
      ...
      <button
        ...
        disabled={busy}
        className="flex items-center gap-1.5 rounded-md border-2 border-accent px-3 py-1.5 text-sm font-semibold text-accent hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-40"
      >
