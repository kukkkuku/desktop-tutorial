...
// 화면 우상단에 아주 작게 띄우는 배지. 실제 업무 기능보다 눈에 띄면 안 되므로
...
export default function VersionCompareBar() {
  return (
    <div className="fixed right-3 top-3 z-[100] flex items-center gap-1 rounded-full border border-gray-200 bg-white/95 p-1 text-xs shadow-sm backdrop-blur">
      <a
        href={LEGACY_URL}
        target="_blank"
